...
DaisyUI LLM instructions placeholder

(Original source: https://daisyui.com/llms.txt)

Note: The assistant could not fetch the remote file due to network/tool restrictions. If you want the exact content from the upstream URL, run this in your local shell inside the repository root:

```powershell
curl -L https://daisyui.com/llms.txt -o .github/instructions/daisyui.instructions.md
```

Or paste the fetched content here and I will update the file.
